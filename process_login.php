...
<?php
 ...
 $sql = "SELECT user_id, user_name, user_pass FROM users WHERE user_name = '$username' AND user_pass = '$password'";
...
echo "</pre>";
 ...
 $stmt = $mysqli->prepare("SELECT user_id, user_name, user_pass FROM users WHERE user_name = ?");
