...
$placeholders = implode(',', array_fill(0, $stmt->param_count, '?'));
$tables = "Jokes_table JOIN users ON users.user_id = jokes_table.user_id";
$whereClause = "Joke_question LIKE ?";
$sql = "SELECT JokeID, Joke_question, Joke_answer, jokes_table.user_id, user_name FROM $tables WHERE $whereClause";
